...
namespace Trabalho1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Labirinto l = new Labirinto(linhas, colunas);
            Console.WriteLine();
            ...
            while (!fechou1)
            {
                Console.WriteLine("Insira as coordenadas do obstaculo, uma de cada vez, no formato (x1,y1), (x2,y2)\n");
                ...
                if (l.geraObstatulo(x1, y1, x2, y2) == 1)
                {
            ...
            while (!fechou2)
            {
                ...
                if(l.posicionaChegada(pos1, pos2))
                {
                    fechou2 = true;
                }
